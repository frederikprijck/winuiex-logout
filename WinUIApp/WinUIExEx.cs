...
#pragma warning restore SA1203 // Constants should appear before fields
    ...
    public sealed class WebAuthenticator
    {
        ...
        public static Task<WinUIEx.WebAuthenticatorResult> AuthenticateAsync(Uri authorizeUri, Uri callbackUri) => Instance.Authenticate(authorizeUri, callbackUri, CancellationToken.None);
        ...
        /// <remarks>Prior to calling this, a call to <see cref="CheckOAuthRedirectionActivation(bool)"/> must be made during application startup.</remarks>
        /// <seealso cref="CheckOAuthRedirectionActivation(bool)"/>
        public static Task<WinUIEx.WebAuthenticatorResult> AuthenticateAsync(Uri authorizeUri, Uri callbackUri, CancellationToken cancellationToken) => Instance.Authenticate(authorizeUri, callbackUri, cancellationToken);
        ...
        private async Task<WinUIEx.WebAuthenticatorResult> Authenticate(Uri authorizeUri, Uri callbackUri, CancellationToken cancellationToken)
        {
            ...
            if (!WinUIExEx.Helpers.IsAppPackaged)
            {
            ...
            return new WinUIEx.WebAuthenticatorResult(uri);
        }
    }
}
